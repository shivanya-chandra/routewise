        ...
        await connection.execute(
            text(
                ...
                alter table llm_requests
                    ...
                    add column if not exists semantic_cache_hit boolean default false,
                    add column if not exists semantic_cache_input_hash varchar,
                    add column if not exists semantic_cache_score numeric,
                    add column if not exists semantic_cache_method varchar,
                    add column if not exists routing_policy varchar default 'balanced',
