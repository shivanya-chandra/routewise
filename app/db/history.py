        ...
        history.append(
            {
                ...
                "semantic_cache_input_hash": row.get("semantic_cache_input_hash"),
                "semantic_cache_score": optional_string(row.get("semantic_cache_score")),
                "semantic_cache_method": row.get("semantic_cache_method"),
                "routing_policy": row.get("routing_policy") or "balanced",
                "prompt_tokens": row["prompt_tokens"],
                "completion_tokens": row["completion_tokens"],
